...
import com.example.anteaterconnectapp.adapter.ChatRecyclerAdapter;
import com.example.anteaterconnectapp.model.ChatMessageModel;
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if(task.isSuccessful()){
                            ...
                            //sendNotification(message); TO DO, this is a lot harder and more confusing than I realize
                        }
                    }
                });
    }
